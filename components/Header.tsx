...
export default function Header() {
  ...
  const [activeServiceImg, setActiveServiceImg] = useState(`${basePath}/img/services/data.png`);
  const images = [
    `${basePath}/img/RedBull-Instagram-Post-45.png`,
    `${basePath}/img/emirates-airpline-in-flight.png`,
    `${basePath}/img/header-bg.png`,
    `${basePath}/img/kitchen.png`,
    `${basePath}/img/spaseekers.png`
  ];
      ...
      <div className="relative w-full overflow-hidden rounded-3xl mt-2">
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                        {[
                          { name: 'Search & Growth Strategy', img: `${basePath}/img/services/three-men.png`, href: 'https://riseatseven.com/services/strategy-growth/' },
                          { name: 'Digital PR', img: `${basePath}/img/services/man-white-shirt.png`, href: 'https://riseatseven.com/services/digital-pr/' },
                          { name: 'Onsite SEO', img: `${basePath}/img/services/woman-presentation.png`, href: 'https://riseatseven.com/services/onsite-seo/' },
                          { name: 'Social Media & Campaigns', img: `${basePath}/img/services/two-men.png`, href: 'https://riseatseven.com/services/social/' },
                          { name: 'Content Experience', img: `${basePath}/img/services/man-card.png`, href: 'https://riseatseven.com/services/content-experience/' },
                          { name: 'Data & Insights', img: `${basePath}/img/services/girl-camera.png`, href: 'https://riseatseven.com/services/data-insights/' },
                          { name: 'B2B Marketing', img: `${basePath}/img/services/data.png`, href: 'https://riseatseven.com/services/b2b-marketing/' },
                          { name: 'Social SEO/Search', img: `${basePath}/img/services/screenshots.png`, href: 'https://riseatseven.com/services/social-seo-tiktok-youtube/' },
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
                  ...
                  >
                    <div className="flex-1">
                      <div className="grid grid-cols-1 gap-x-2 gap-y-1">
                        {[
                          { name: 'B2B Marketing', img: `${basePath}/img/services/two-men.png`, href: 'https://riseatseven.com/services/b2b-marketing/' }
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
                  ...
                  >
                    <div className="flex-1">
                      <div className="grid grid-cols-1 gap-x-4 gap-y-1">
                        {[
                          { name: 'US Digital PR', img: `${basePath}/img/services/three-men.png`, href: 'https://riseatseven.com/international/us-digital-pr/' },
                          { name: 'Spain Digital PR', img: `${basePath}/img/services/spain.png`, href: 'https://riseatseven.com/international/us-digital-pr/spain-digital-pr/' },
                          { name: 'Germany Digital PR', img: `${basePath}/img/services/germany.png`, href: 'https://riseatseven.com/germany-digital-pr/' },
                          { name: 'Netherlands Digital PR', img: `${basePath}/img/services/netherlands.png`, href: 'https://riseatseven.com/netherlands-digital-pr/' }
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
                ...
                >
                  ...
                  >
                    <div className="flex-1">
                      <div className="grid grid-cols-1 gap-x-4 gap-y-1">
                        {[
                          { name: 'About Us', img: `${basePath}/img/services/about-us.png`, href: 'https://riseatseven.com/about/' },
                          { name: 'Meet The Risers', img: `${basePath}/img/services/three-men.png`, href: 'https://riseatseven.com/meet-the-team/' },
                          { name: 'Culture', img: `${basePath}/img/services/culture.png`, href: 'https://riseatseven.com/culture/' },
                          { name: 'Testimonials', img: `${basePath}/img/services/pr-week.png`, href: 'https://riseatseven.com/testimonials/' }
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
                ...
                >
                  ...
                  >
                    <div className="flex-1">
                      <div className="grid grid-cols-1 gap-x-4 gap-y-1">
                        {[
                          { name: 'Blog', img: `${basePath}/img/services/blog.png`, href: 'https://riseatseven.com/blog/' },
                          { name: 'Category Leaderboard', img: `${basePath}/img/services/leaderboard.png`, href: 'https://riseatseven.com/category-leaderboard/' },
                          { name: 'Multi-Channel Search Report', img: `${basePath}/img/services/report.png`, href: 'https://riseatseven.com/multi-channel-search-report-2026-/' }
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
        ...
        <div className="flex flex-col items-center pt-8 pb-2 px-2 sm:px-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-y-4 gap-x-1 sm:gap-x-4 opacity-80">
            ...
            <img src={`${basePath}/img/services/global-search-awards.png`} alt="Global Search Awards" className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <img src={`${basePath}/img/services/mask-group.png`} alt="The Drum" className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <img src={`${basePath}/img/services/ukSocial-Media-Awards-White.png`} alt="UK Social Media Awards" className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <img src={`${basePath}/img/services/uk-Content-Awards-White.png`} alt="Content Awards" className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <svg viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 sm:w-6 fill-current text-white">
