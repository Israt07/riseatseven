      ...
      <div className="relative w-full overflow-hidden rounded-3xl mt-2">
        ...
        <div className="absolute inset-0 overflow-hidden -z-10">
          <div
            ...
            style={{ backgroundImage: `url('${basePath}${currentImage}')` }}
          />
        </div>
        ...
        <div className="flex flex-col items-center pt-8 pb-2 px-2 sm:px-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-y-4 gap-x-1 sm:gap-x-4 opacity-80">
            ...
            <Image src="/img/services/global-search-awards.png" alt="Global Search Awards" width={100} height={40} className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <Image src="/img/services/mask-group.png" alt="The Drum" width={100} height={40} className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <Image src="/img/services/ukSocial-Media-Awards-White.png" alt="UK Social Media Awards" width={100} height={40} className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <Image src="/img/services/uk-Content-Awards-White.png" alt="Content Awards" width={100} height={40} className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <svg viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 sm:w-6 fill-current text-white">
