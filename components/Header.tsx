...
export default function Header() {
  const [activeServiceImg, setActiveServiceImg] = useState(`${bp}/img/services/data.png`);
  const images = [
    `${bp}/img/RedBull-Instagram-Post-45.png`,
    `${bp}/img/emirates-airpline-in-flight.png`,
    `${bp}/img/header-bg.png`,
    `${bp}/img/kitchen.png`,
    `${bp}/img/spaseekers.png`
  ];
      ...
      <div className="relative w-full overflow-hidden rounded-3xl mt-2">
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                        {[
                          { name: 'Search & Growth Strategy', img: `${bp}/img/services/three-men.png`, href: 'https://riseatseven.com/services/strategy-growth/' },
                          { name: 'Digital PR', img: `${bp}/img/services/man-white-shirt.png`, href: 'https://riseatseven.com/services/digital-pr/' },
                          { name: 'Onsite SEO', img: `${bp}/img/services/woman-presentation.png`, href: 'https://riseatseven.com/services/onsite-seo/' },
                          { name: 'Social Media & Campaigns', img: `${bp}/img/services/two-men.png`, href: 'https://riseatseven.com/services/social/' },
                          { name: 'Content Experience', img: `${bp}/img/services/man-card.png`, href: 'https://riseatseven.com/services/content-experience/' },
                          { name: 'Data & Insights', img: `${bp}/img/services/girl-camera.png`, href: 'https://riseatseven.com/services/data-insights/' },
                          { name: 'B2B Marketing', img: `${bp}/img/services/data.png`, href: 'https://riseatseven.com/services/b2b-marketing/' },
                          { name: 'Social SEO/Search', img: `${bp}/img/services/screenshots.png`, href: 'https://riseatseven.com/services/social-seo-tiktok-youtube/' },
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
                  ...
                  >
                    <div className="flex-1">
                      <div className="grid grid-cols-1 gap-x-2 gap-y-1">
                        {[
                          { name: 'B2B Marketing', img: `${bp}/img/services/two-men.png`, href: 'https://riseatseven.com/services/b2b-marketing/' }
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
                  ...
                  >
                    <div className="flex-1">
                      <div className="grid grid-cols-1 gap-x-4 gap-y-1">
                        {[
                          { name: 'US Digital PR', img: `${bp}/img/services/three-men.png`, href: 'https://riseatseven.com/international/us-digital-pr/' },
                          { name: 'Spain Digital PR', img: `${bp}/img/services/spain.png`, href: 'https://riseatseven.com/international/us-digital-pr/spain-digital-pr/' },
                          { name: 'Germany Digital PR', img: `${bp}/img/services/germany.png`, href: 'https://riseatseven.com/germany-digital-pr/' },
                          { name: 'Netherlands Digital PR', img: `${bp}/img/services/netherlands.png`, href: 'https://riseatseven.com/netherlands-digital-pr/' }
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
                ...
                >
                  ...
                  >
                    <div className="flex-1">
                      <div className="grid grid-cols-1 gap-x-4 gap-y-1">
                        {[
                          { name: 'About Us', img: `${bp}/img/services/about-us.png`, href: 'https://riseatseven.com/about/' },
                          { name: 'Meet The Risers', img: `${bp}/img/services/three-men.png`, href: 'https://riseatseven.com/meet-the-team/' },
                          { name: 'Culture', img: `${bp}/img/services/culture.png`, href: 'https://riseatseven.com/culture/' },
                          { name: 'Testimonials', img: `${bp}/img/services/pr-week.png`, href: 'https://riseatseven.com/testimonials/' }
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
                ...
                >
                  ...
                  >
                    <div className="flex-1">
                      <div className="grid grid-cols-1 gap-x-4 gap-y-1">
                        {[
                          { name: 'Blog', img: `${bp}/img/services/blog.png`, href: 'https://riseatseven.com/blog/' },
                          { name: 'Category Leaderboard', img: `${bp}/img/services/leaderboard.png`, href: 'https://riseatseven.com/category-leaderboard/' },
                          { name: 'Multi-Channel Search Report', img: `${bp}/img/services/report.png`, href: 'https://riseatseven.com/multi-channel-search-report-2026-/' }
                        ].map((service) => (
                          <a
                            key={service.name}
                            href={service.href || "#"}
        ...
        <div className="flex flex-col items-center pt-8 pb-2 px-2 sm:px-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-y-4 gap-x-1 sm:gap-x-4 opacity-80">
            ...
            <Image src={`${bp}/img/services/global-search-awards.png`} alt="Global Search Awards" width={100} height={40} className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <Image src={`${bp}/img/services/mask-group.png`} alt="The Drum" width={100} height={40} className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <Image src={`${bp}/img/services/ukSocial-Media-Awards-White.png`} alt="UK Social Media Awards" width={100} height={40} className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <Image src={`${bp}/img/services/uk-Content-Awards-White.png`} alt="Content Awards" width={100} height={40} className="h-3 sm:h-4 w-auto object-contain brightness-0 invert px-1 sm:px-2" />
            <svg viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 sm:w-6 fill-current text-white">
        ...
        <div className="flex flex-col items-center text-center px-6 py-6 overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4" style={{ fontSize: 'clamp(2.5rem, 8vw, 9rem)' }}>
            ...
            >
              <Image src={currentImage} alt="Client" width={200} height={200} className="w-full h-full object-cover" />
            </div>
