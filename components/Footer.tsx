...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#111111] text-white overflow-hidden rounded-3xl m-2 font-sans">
      <div className="w-full px-4 sm:px-8 pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-16 lg:mb-18">

          {/* Left: Newsletter & Socials */}
          <div className="col-span-12 lg:col-span-4 flex flex-col gap-6 pr-0 lg:pr-8 items-start text-left">
            <h2 className="text-xl lg:text-2xl font-bold text-white leading-tight">
              Stay updated with Rise news
            </h2>

            {/* Input Field */}
            <div className="flex items-center bg-[#1a1a1a] rounded-full px-5 py-2.5 gap-3 border border-white/10">
              <input
                type="email"
                placeholder="Your Email Address"
                className="flex-1 bg-transparent text-white text-sm outline-none placeholder:text-white/40"
              />
              <button className="w-9 h-9 rounded-full bg-[#5efcd0] flex items-center justify-center flex-shrink-0 hover:scale-105 transition-all">
                <i className="fa-solid fa-arrow-up rotate-45 text-black text-sm"></i>
              </button>
            </div>

            {/* Social Icons */}
            <div className="flex items-center gap-3 flex-wrap justify-start pl-1 sm:pl-0">
              {socialLinks.map((social, i) => (
                <a
                  ...
                  className="group inline-flex items-center gap-x-2 rounded-full bg-white px-3 py-1.5 transition-transform hover:scale-105"
                >
                  <i className={`${social.icon} text-black text-[10px]`} aria-hidden="true"></i>
                  <i className="fa-solid fa-arrow-up rotate-45 text-black opacity-60 group-hover:opacity-100 text-[8px] transition-opacity" aria-hidden="true"></i>
                </a>
              ))}
            </div>
          </div>
          ...
          {/* Right: Nav Columns */}
          <div className="col-span-12 lg:col-span-8 grid grid-cols-2 md:flex md:flex-row gap-y-10 gap-x-4 md:gap-x-16 lg:gap-x-24 lg:pl-12 xl:pl-20">

            {/* Col 1: Main Nav */}
            <div className="flex flex-col gap-y-1.5 border-l border-white/20 pl-3 md:w-auto">
              {[
                ...
                <a key={item.label} href={item.href} className="text-lg lg:text-xl font-bold text-white hover:opacity-60 transition-opacity">
                  {item.label}
                </a>
              ))}
            </div>
            ...
            {/* Col 3: Locations */}
            <div className="flex flex-col gap-y-1.5 border-l border-white/20 pl-4 md:w-auto">
              {[
                { label: 'Sheffield', href: 'https://www.google.com/search?sca_esv=8db88439da67627d&kgmid=/g/11hyn8b1gq&q=Rise+at+Seven&shndl=30&shem=lcuae,uaasie&source=sh/x/loc/uni/m1/1&kgs=268398410a873372' },
                { label: 'Manchester', href: 'https://www.google.com/search?sca_esv=8db88439da67627d&kgmid=/g/11lcywp77r&q=Rise+at+Seven&shndl=30&shem=lcuae,uaasie&source=sh/x/loc/uni/m1/1&kgs=d2b44712e74b3077' },
                { label: 'London', href: 'https://www.google.com/search?sca_esv=8db88439da67627d&cs=0&output=search&kgmid=/g/11y2nn1mzs&q=Rise+at+Seven&shndl=30&shem=lcuae,uaasie&source=sh/x/loc/uni/m1/1&kgs=655b606682d27601' },
                { label: 'New York', href: 'https://www.google.com/search?sca_esv=4ac5f19825565b74&sxsrf=AE3TifPxolB4J2zP57LLMS3K0faFHfFQiw:1751988657791&kgmid=/g/1q63cm5z5&q=WeWork+Office+Space+%26+Coworking&shndl=30&shem=lcuae,lspt8,uaasie&source=sh/x/loc/uni/m1/1&kgs=e1c62ff8077b5da5' },
      ...
      {/* Giant Wordmark */}
      <div className="w-full px-4 sm:px-8 pb-0">
        <div className="flex items-end justify-between">
          <div className="w-full text-white">
            <svg className="w-full h-auto object-contain fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168 21">
      ...
      <div className="w-full px-4 sm:px-8 py-6">
        <div className="w-full flex items-center justify-between gap-4 flex-wrap">
          ...
          <span className="text-white/40 text-xs">Website MadeByShape</span>
        </div>
      </div>
    </footer >
  );
